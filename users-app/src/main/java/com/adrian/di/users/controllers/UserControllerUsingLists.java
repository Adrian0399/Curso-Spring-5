package com.adrian.di.users.controllers;
...
import com.adrian.di.users.services.UserServiceUsingLists;
...
public class UserControllerUsingLists {
	...
	public ResponseEntity<List<User>> getUsers(@RequestParam(value = "starWith", required = false)String startWith){
